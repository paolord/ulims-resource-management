...
class InventoriesController extends Controller
{
	...
	public function actionView($id)
	{
		...
		$file = Yii::getPathOfAlias('webroot').'/upload/initial.txt';
		...
		{
            Yii::import('application.extensions.spout.readInitialInventoryFile', true);
            $reader = new readInitialInventoryFile();
            $data = $reader->read($objReader->load($_FILES['import_path']['tmp_name']));
    ...
    public function actionInitialInventoryForm(){
        Yii::app()->getRequest()->sendFile( "Initial_Inventory_Data_Entry_Form.xlsx" , file_get_contents( Yii::app()->basePath."/modules/inventory/Initial_Inventory_Data_Entry_Form.xlsx" ) );
    }
