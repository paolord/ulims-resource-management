...
class RestSuppliersController extends Controller
{
   ...
   *
	 */
/*
Mobile REST API Usage for create endpoint ("inventory/restSuppliers/create"):
...
*/
	 ...
	 */
/*
Same usage as create endpoint except attach an 'id' variable as GET data (e.g. "inventory/restSuppliers/update?id=1")
...
*/
  ...
  /*
  Same usage as update endpoint, attach an 'id' variable as GET data (e.g. "inventory/restSuppliers/delete?id=1")
